...
class CI_Template
{
	...
	public function get_theme_path_js($file)
	{
		return $this->_theme_path.'js/'.$file.'.js';
	}

	public function get_theme_path_css($file)
	{
		return $this->_theme_path.'css/'.$file.'.css';
	}

	public function get_theme_path_img($file)
	{
		return $this->_theme_path.'img/'.$file;
	}
